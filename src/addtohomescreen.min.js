...
!function(e, t) {
    ...
    function s() {
        ...
        h.test(t.location.href) && history.replaceState("", e.document.title, t.location.href.replace(h, "$1")),
        d.test(t.location.search) && history.replaceState("", e.document.title, t.location.href.replace(d, "$2"))
    }
    ...
    n.Class = function(i) {
        ...
        o(this.options, i),
        i.debug && "undefined" == typeof i.logging && (this.options.logging = !0),
        a) {
    ...
    n.Class.prototype = {
        ...
        show: function(i) {
            ...
            this.updateSession(),
            this.applicationIcon || (this.applicationIcon = t.querySelector("ios" == n.OS ? 'head link[rel^=apple-touch-icon][sizes="152x152"],head link[rel^=apple-touch-icon][sizes="144x144"],head link[rel^=apple-touch-icon][sizes="120x120"],head link[rel^=apple-touch-icon][sizes="114x114"],head link[rel^=apple-touch-icon]' : 'head link[rel^="shortcut icon"][sizes="196x196"],head link[rel^=apple-touch-icon]'));
            var a = "";
            ...
            a = "<p>" + a.replace("%icon", '<span class="ath-action-icon">icon</span>') + "</p>",
            a = "<p>" + a.replace("%aths-icon", '<span class="ath-aths-icon">aths-icon</span>') + "</p>",
